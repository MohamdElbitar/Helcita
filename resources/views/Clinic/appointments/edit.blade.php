        ...
        <div class="container-fluid">
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <h4 class="page-title">@lang('Edit Appointment')</h4>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-right">
                            ...
                            <li class="breadcrumb-item active">@lang('Edit Appointment')</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card m-b-30">
                        <div class="card-body">
                            ...
                            <form action="{{ route('Clinic.appointments.update', $appointment->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="price" class="form-control" value="{{ $appointment->price }}" required>
                                </div>

                                <div class="form-group">
                                    <label>@lang('Appointment Type')</label><br>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="type_checkup" name="appointment_type" value="checkup" class="form-check-input" {{ $appointment->appointment_type == 'checkup' ? 'checked' : '' }} required>
                                        <label class="form-check-label" for="type_checkup">@lang('Checkup')</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="type_consultation" name="appointment_type" value="consultation" class="form-check-input" {{ $appointment->appointment_type == 'consultation' ? 'checked' : '' }} required>
                                        <label class="form-check-label" for="type_consultation">@lang('Consultation')</label>
                                    </div>
                                </div>

                                <button type="submit" class="btn btn-success">@lang('Update Appointment')</button>
                            </form>
